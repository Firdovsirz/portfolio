...
seoTitle: "Rubric-Constrained LLM Scoring Pipeline"
seoDescription: "How AzTU scores thousands of yearly plan reports with an LLM instead of a human evaluator, and the engineering that keeps those scores fair and auditable."
